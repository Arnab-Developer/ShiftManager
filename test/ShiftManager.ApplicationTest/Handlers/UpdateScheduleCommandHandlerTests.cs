...
{
    [Fact]
    public async Task Can_UpdateScheduleCommandHandler_WorksProperly()
    {
        // Arrange.
        ...
        {
            EmployeeId = 1,
            Date = DateTime.Parse("4 Oct 2024"),
            Shift = Shift.Night
        };

        var shiftRepoMock = new Mock<IShiftRepo>();
        var handler = new UpdateScheduleCommandHandler(shiftRepoMock.Object);
    ...
    [Fact]
    public async Task Can_UpdateScheduleCommandHandler_ThrowException_IfGetEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
    ...
    [Fact]
    public async Task Can_UpdateScheduleCommandHandler_ThrowException_IfUpdateEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
