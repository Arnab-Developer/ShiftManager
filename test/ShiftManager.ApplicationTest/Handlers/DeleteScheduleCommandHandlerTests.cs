...
{
    [Fact]
    public async Task Can_DeleteScheduleCommandHandler_WorksProperly()
    {
        // Arrange.
        ...
        var handler = new DeleteScheduleCommandHandler(shiftRepoMock.Object);
    ...
    [Fact]
    public async Task Can_DeleteScheduleCommandHandler_ThrowException_IfGetEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
    ...
    [Fact]
    public async Task Can_DeleteScheduleCommandHandler_ThrowException_IfUpdateEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
