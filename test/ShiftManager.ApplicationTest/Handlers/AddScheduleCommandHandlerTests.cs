...
{
    [Fact]
    public async Task Can_AddScheduleCommandCommandHandler_WorksProperly()
    {
        // Arrange.
        ...
        {
            EmployeeId = 1,
            Date = DateTime.Parse("2 Mar 2023"),
            Shift = Shift.Day
        };

        var shiftRepoMock = new Mock<IShiftRepo>();
        var handler = new AddScheduleCommandCommandHandler(shiftRepoMock.Object);
        ...
        Assert.Equal(3, employee.Schedules.Count);
        ...
        Assert.Equal(DateTime.Parse("2 Mar 2023"), employee.Schedules.ElementAt(2).Date);
        Assert.Equal(Shift.Day, employee.Schedules.ElementAt(2).Shift);
    ...
    [Fact]
    public async Task Can_AddScheduleCommandCommandHandler_ThrowException_IfGetEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
    ...
    [Fact]
    public async Task Can_AddScheduleCommandCommandHandler_ThrowException_IfUpdateEmployeeAsyncThrowException()
    {
        // Arrange.
        var employee = new Employee("Jon", "Doe");
